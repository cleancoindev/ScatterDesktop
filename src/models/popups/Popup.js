...
const NotificationService = () =>
  remote ? remote.getGlobal('appShared').NotificationService : null
...
export class Popup {
  constructor(
    _displayType = PopupDisplayTypes.POP_IN,
    _data = new PopupData(),
    internal = false
  ) {
  ...
  static fromJson(json) {
    return Object.assign(new Popup(), json)
  }
  ...
  appData() {
    return this.data.props.appData
  }
  payload() {
    return this.data.props.payload
  }
  origin() {
  ...
  static popout(data, callback, internal = false) {
    return new Popup(
      PopupDisplayTypes.POP_OUT,
      new PopupData(data.type, data, callback),
      internal
    )
  }
  ...
  static prompt(
    ...
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.PROMPT, params, callback)
    )
  }
  ...
  static selectFromList(title, list, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SELECT_FROM_LIST, { title, list }, callback)
    )
  }
  ...
  static transactionSuccess(blockchain, tx, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.TX_SUCCESS, { blockchain, tx }, callback)
    )
  }
  ...
  static snackbar(message, icon, timeout = 3000) {
    return new Popup(
      ...
      new PopupData('', { message, icon, timeout })
    )
  }
  ...
  static enterPIN(callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.ENTER_PIN, {}, callback)
    )
  }
  ...
  static removeApp(origin, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.REMOVE_APP, { origin }, callback)
    )
  }
  ...
  static updateAvailable(update, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.UPDATE_AVAILABLE, { update }, callback)
    )
  }
  ...
  static showTerms(callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SHOW_TERMS, {}, callback)
    )
  }
  ...
  static enterSecurityCode(subtitle, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SECURITY_CODE, { subtitle }, callback)
    )
  }
  ...
  static verifyPassword(callback, returnOnly = false) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.VERIFY_PASSWORD, { returnOnly }, callback)
    )
  }
  ...
  static changeIdentityKey(identity, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.CHANGE_IDENTITY_KEY, { identity }, callback)
    )
  }
  ...
  static eosChangePermissions(account, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.EOS_CHANGE_PERMISSIONS, { account }, callback)
    )
  }
  ...
  static eosProxyVotes(account, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.EOS_PROXY_VOTES, { account }, callback)
    )
  }
  ...
  static eosModerateRam(account, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.EOS_MODERATE_RAM, { account }, callback)
    )
  }
  ...
  static eosModerateCpuNet(account, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.EOS_MODERATE_CPU_NET, { account }, callback)
    )
  }
  ...
  static eosCreateAccount(account, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.EOS_CREATE_ACCOUNT, { account }, callback)
    )
  }
  ...
  static eosLinkAccount(keypair, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.EOS_LINK_ACCOUNT, { keypair }, callback)
    )
  }
  ...
  static addCustomNetwork(blockchain, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.ADD_CUSTOM_NETWORK, { blockchain }, callback)
    )
  }
  ...
  static addNewContact(blockchain, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.ADD_NEW_CONTACT, { blockchain }, callback)
    )
  }
  ...
  static unlinkAccount(account, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.UNLINK_ACCOUNT, { account }, callback)
    )
  }
  ...
  static removeKeypair(keypair, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.REMOVE_KEYPAIR, { keypair }, callback)
    )
  }
  ...
  static destroyScatter(callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.DESTROY_SCATTER, {}, callback)
    )
  }
  ...
  static importFullBackup(options, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.IMPORT_FULL_BACKUP, { options }, callback)
    )
  }
  ...
  static importKeypair(options, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.IMPORT_KEYPAIR, { options }, callback)
    )
  }
  ...
  static generateKeypair(options, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.GENERATE_KEYPAIR, { options }, callback)
    )
  }
  ...
  static checkHardwareWalletScreen() {
    NotificationService().pushNotification(
      'Check Hardware',
      'Please check your hardware screen.'
    )
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.CHECK_HARDWARE, {}, () => {})
    )
  }
  ...
  static enableWhitelist(callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.ENABLE_WHITELIST, {}, callback)
    )
  }
  ...
  static selectTokenAndAccount(callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SELECT_TOKEN_AND_ACCOUNT, {}, callback)
    )
  }
  ...
  static selectAccount(callback, validAccounts = null) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SELECT_ACCOUNT, { validAccounts }, callback)
    )
  }

  static selectKeypair(
    callback,
    blockchains = BlockchainsArray.map(x => x.value)
  ) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SELECT_KEYPAIR, { blockchains }, callback)
    )
  }
  ...
  static selectRecipient(blockchain = null, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SELECT_RECIPIENT, { blockchain }, callback)
    )
  }
  ...
  static selectToken(tokens, callback) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SELECT_TOKEN, { tokens }, callback)
    )
  }

  static selectBlockchain(
    callback,
    blockchains = BlockchainsArray.map(x => x.value)
  ) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.SELECT_BLOCKCHAIN, { blockchains }, callback)
    )
  }
  ...
  static setDisplayToken(callback = () => {}) {
    return new Popup(
      PopupDisplayTypes.POP_IN,
      new PopupData(PopupTypes.DISPLAY_TOKEN, {}, callback)
    )
  }
}
