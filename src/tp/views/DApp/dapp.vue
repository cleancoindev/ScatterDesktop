          ...
          {{item.title}}
            ...
            <el-row :gutter="20" class="category-list">
                <el-col class="dapp-list" v-for="(item, index) in dappList" :key="index">
                    <div class="dapp-wrap pointer" @click.prevent="goGame(item.url)">
                        <div class="dapp-header">
                            <i class="dapp-icon"
                               :style="{background: `url('${item.icon_url}') no-repeat center 100%/cover`}"></i>
...
<style lang="scss" scoped>
    ...
    .icon-detail {
        ...
        width: 18px;
        height: 19px;
        background: url(../../assets/images/icon-detail.png) no-repeat 100% 100%/100% 100%;
    }
    ...
    .icon-game {
        ...
        width: 24px;
        height: 19px;
        background: url(../../assets/images/icon-game.png) no-repeat 100% 100%/100% 100%;
    }
