  ...
  <section class="pop-over">
    ...
    <section class="success">
      <section>
        ...
        <Button :text="$t('TP.GENERIC.Okay')" @click.native="returnResult(true)" blue="1" />
      </section>
    </section>
  </section>
</template>
